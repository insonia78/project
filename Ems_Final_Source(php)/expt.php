...
error_reporting(0);
    ...
    header("Expires: 0");
 include ('config.php');
$sql = "SELECT AssignID,AssignStatus,therapeuticArea,repname,repcell,repemail,partname,part2name,shootdate,shoottimehrs,shoottimemins,ampm,practicename,practicestreet,practicecity,practicestate,practicezip,practicephone FROM assignments where AssignStatus !=''";
...
//////////////////////////////////
        ...
        $objPHPExcel->getActiveSheet()->getCell('B2')->setValue('Client Service Report');      
...
header('Content-Disposition: attachment;filename="Client Service Report-'.date('Ymd h_i_s ').'.xls"');
