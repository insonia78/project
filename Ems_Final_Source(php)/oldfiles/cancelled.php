...
<div id="main_wrapper">
	<div class="main_content">
        ...
        <div class="enroll_content">
        	<a href="canceled_export.php" style="float: right; margin-right: 168px; margin-top: -30px;">Export Canceled</a> <a href="expt.php" style="float: right; margin-right: 82px; margin-top: -30px;">Export All </a>       	<a href="logout.php" style="float: right; margin-top: -30px;">+Logout</a>
        	<div class="tab_conatiner">
                ...
                <a href="cancelled.php"><div class="tab_tit active_state" id="tab2">Canceled</div></a>
