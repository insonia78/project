...
$query = "select shootdate,shootername,AssignID,therapeuticArea,practicestate,physname,repname,AssignStatus from assignments where AssignStatus = 'cancelled'";
	...
	<div class="main_content">
        ...
        <div class="enroll_content">
        	...
        	<div class="tab_conatiner">
                ...
                <div class="tab_tit active_state" id="tab2"><a href="cancelled.php">Cancelled</a></div>
