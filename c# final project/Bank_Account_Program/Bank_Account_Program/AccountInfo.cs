    ...
    public partial class Account_info : Form
    {
        ...
        private void txtAccountNumber_TextChanged(object sender, EventArgs e)
        {
            if (choose == true)
            {
                ...
                {
                    MessageBox.Show("Account Number:\nYou entered invalid values" + ex.Message, "Account Number");
                    txtAccountNumber.Clear();
                }
            }
        ...
        private bool Validate()
        {
            ...
            else
            {
              ...
              try
              {
                  balanceValue = Decimal.Parse(txtBegingBalance.Text);
                  validate++;
              }
              catch (System.FormatException ex)
              {
                  MessageBox.Show("Beginnig Balance:\nEnter a numeric Balance" + ex.Message, "Starting Balance");
