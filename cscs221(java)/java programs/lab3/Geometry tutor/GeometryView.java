   ...
   private int userChoice;
    ...
    public void start()
    {
      ...
      if (userChoice == 1){
          ...
          System.out.println(master.getName() + "says the area of the circle is " + area);
            ...
            System.out.println(master.getName() + "says the area of the rectanlge is " + area);
            ...
            System.out.println(master.getName() + "says the area of the triangle is " + area);
