...

{
	...
	Constructor
	*/
	public ActionArrayClientCorrecet()
	{
        // Title of the window
                 ...
                 else // sort the array
                 {
					 ...
					 do
					 {
						 ...
						 for(int i = 0; i < (arrayLength - 1) ;i++)
						 {
								...
								{
									temp = array[i];
									System.out.println("This is the temp value" +temp+"array[i]"+array[i]);
								    array[i] = array[i+1];
								    System.out.println("this is the array[i]"+array[i]+"array[i+1]"+array[i+1]);
								    array[i+1] = temp;
								    System.out.println("this is array[i+1]"+array[i+1]+"temp"+temp);
								    swap = true;
