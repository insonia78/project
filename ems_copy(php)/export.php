 ...
 switch($status)
{
      ...
      {      
           ...
           $sql = "SELECT AssignID,AssignStatus,therapeuticArea,repname,repcell,repemail,partname,part2name,shootdate,shoottimehrs,shoottimemins,ampm,practicename,practicestreet,practicecity,practicestate,practicezip,practicephone FROM assignments where AssignStatus = 'postponed'";

      }
      case 'canceled':
      {
         $sql = "SELECT AssignID,AssignStatus,therapeuticArea,repname,repcell,repemail,partname,part2name,shootdate,shoottimehrs,shoottimemins,ampm,practicename,practicestreet,practicecity,practicestate,practicezip,practicephone FROM assignments where AssignStatus = 'canceled'";
      ...
      default :
      {
          $sql = "SELECT AssignID,AssignStatus,therapeuticArea,repname,repcell,repemail,partname,part2name,shootdate,shoottimehrs,shoottimemins,ampm,practicename,practicestreet,practicecity,practicestate,practicezip,practicephone FROM assignments where AssignStatus = 'pending'";
...
//////////////////////////////////
        ...
        $objPHPExcel->getActiveSheet()->getCell('B2')->setValue('Pending Report');      
...
header('Content-Disposition: attachment;filename="Pending Report-'.date('Ymd h_i_s ').'.xls"');
