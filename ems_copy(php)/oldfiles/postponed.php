...
<div id="main_wrapper">
	<div class="main_content">
        ...
        <div class="enroll_content">
        	<a href="postponed_export.php" style="float: right; margin-right: 168px; margin-top: -30px;">Export Postponed</a>  <a href="expt.php" style="float: right; margin-right: 82px; margin-top: -30px;">Export All </a>       	<a href="logout.php" style="float: right; margin-top: -30px;">+Logout</a>
        	<div class="tab_conatiner">
                <a href="upcomming.php"><div class="tab_tit " id="tab1">Pending</div></a>
                <a href="postponed.php"><div class="tab_tit active_state" id="tab2">Postponed</div></a>
	           ...
	           <th style=" display: none;"></th>
                ...
                <?php while ($row = mysql_fetch_assoc($result)) {?>
                  ...
                  <tr class="bor">
                    ...
                    <td <?php if(strlen($row['shootername'])>25){?> title="<?php echo $row['shootername'];?>" <?php }?>><?php if(strlen($row['shootername'])>25){ echo substr($row['shootername'],0,20).'...';}else{ echo $row['shootername']; }?></td>
