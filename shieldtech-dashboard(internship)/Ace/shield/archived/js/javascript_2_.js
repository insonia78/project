...
var archiveAlert = function (value) {
  ...
  $.ajax({
    ...
    if (data === "success") {
      $('div#object' + value).slideUp("fast", function () {
        $('div#object' + value).remove();
      });
    } else {
      alert(data);
    }
